    ...
    public void component() {
        ...
        button2.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent arg0){
                try{
                    Desktop.getDesktop().open(new java.io.File("image/tutorial.txt"));
        ...
        */
        //move next layout of bt2
        //button2.addActionListener(e->action(e)); 
        ...
        /*name_label0 = new JLabel(name_jare);
        name_label1 = new JLabel(name_jow);
        name_label2 = new JLabel(name_sub);
        name_label3 = new JLabel(name_fiat);
         */
